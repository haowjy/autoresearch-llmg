...
description: |
  Load when you coordinate work across multiple spawns rather than implementing directly. Delegation discipline, convergence loops, escalation, artifact persistence.
