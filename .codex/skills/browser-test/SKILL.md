...
name: browser-test
description: |
  Use when verifying a frontend change requires a real browser — visual rendering, user flows, form behavior, accessibility, or console error detection that only surfaces at runtime. Pair with `/playwright-cli` for browser mechanics.
