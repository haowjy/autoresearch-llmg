...
name: md-validation
description: |
  Use when writing, reviewing, or refactoring markdown docs and you need fast validation of links or Mermaid diagrams. Trigger on phrases like "check docs", "find broken links", "validate mermaid", "map doc structure", or before committing documentation changes.
---
