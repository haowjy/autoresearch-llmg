...
description: |
  Orients a documentation coordinator into post-implementation knowledge capture mode. Pass as --skills post-impl-capture when spawning @kb-lead after implementation ships. Provides the specific coordination sequence for mining implementation sessions, assessing scope, fanning out writers, and reviewing coverage.
