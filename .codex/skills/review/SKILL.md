...
name: review
description: |
  Load when reviewing code, designs, or plans — adversarial mindset, severity handling, and structured reporting. Use for PR reviews, phase reviews, design reviews, and any task where the goal is finding problems.
