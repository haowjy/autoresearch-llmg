...
name: simplify
description: |
  Load when hunting structural friction — shallow modules, fragmentation, deletion targets, and opportunities to make the codebase easier to change. Method for finding what to collapse, delete, inline, or deepen. Use with `/review` for adversarial structural analysis.
