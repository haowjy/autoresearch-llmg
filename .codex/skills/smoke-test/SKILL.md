...
name: smoke-test
description: |
  Use when you need to understand or verify runtime behavior against the real system — CLI invocations, HTTP requests, integration flows, race probes, interruption recovery. Two modes: probing (how does this behave?) and verification (does this change work?). Mandatory for integration boundaries.
