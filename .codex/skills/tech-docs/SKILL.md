...
name: tech-docs
description: |
  Load when writing design documents — architecture specs, behavioral specs, component docs, feasibility reports. Covers structure and clarity for the artifacts under design/ in the work directory.
