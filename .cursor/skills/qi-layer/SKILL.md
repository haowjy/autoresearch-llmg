...
name: qi-layer
description: |
  Use when writing, reading, or deciding where to place inline knowledge — AGENTS.md and .context/CONTEXT.md files colocated with the content they describe. Covers what belongs in each, how they relate, and what goes elsewhere.
---
